/***  READREC2 montre comment utiliser un tableau de structure pour la      ***/
     ...
     do
       {
         ...
         printf("Ce programme vous permet de saisir une bibliographie \n"
                "de 50 titres au plus. Fin de saisie par \'0\'.");
         ...
         if (l[i].auteur.nom[0] != '0')   /* ce n'est pas la fin de la saisie */
            {
              printf("\nPr‚nom : ");
              ...
              while (getchar() != '\n')       /* pour enlever '\n' du tampon. */ 
                         ;           /* Sinon le caractŠre serait compris par */
                                        /*  gets comme ‚tant le prochain nom. */
            }
  
         i++;
  
       } while (i < 50  &&  l[i-1].auteur.nom[0] != '0');
                                              /* tant que ni 50 fiches ni '0' */
